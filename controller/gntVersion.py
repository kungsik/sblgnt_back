...
def getGnt(book='Matthew', chapter=1):
    ...
    for v in verseNode:
        ...
        for w in wordsNode:
            ...
            verse += '<span class=gntwordNode><a tabindex=0 class=sblgnt_word_elm data-poload=http://kungsik1.pythonanywhere.com/api/word/gnt/'+str(w)+' data-toggle=popover data-trigger=focus>'
