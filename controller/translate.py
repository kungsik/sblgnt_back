translate = {
    ...
    "du": {"full": "쌍수", "abbr": "쌍"},
    "pl": {"full": "복수", "abbr": "복"},
    "Plural": {"full": "복수", "abbr": "복"},
    "m": {"full": "남성", "abbr": "남"},
    "Masculine": {"full": "남성", "abbr": "남"},
    "f": {"full": "여성", "abbr": "여"},
    "Feminine": {"full": "여성", "abbr": "여"},
    "Neuter": {"full": "중성", "abbr": "중"},
    "p1": {"full": "1인칭", "abbr": "1"},
    "First": {"full": "1인칭", "abbr": "1"},
    "p2": {"full": "2인칭", "abbr": "2"},
    "Second": {"full": "2인칭", "abbr": "2"},
    "p3": {"full": "3인칭", "abbr": "3"},
    "Third": {"full": "3인칭", "abbr": "3"},
    "perf": {"full": "완료형", "abbr": "완"},
    "Perfect": {"full": "완료형", "abbr": "완"},
    "impf": {"full": "미완료형", "abbr": "미완"},
    "Imperfect": {"full": "미완료형", "abbr": "미완"},
    "wayq": {"full": "봐이크톨", "abbr": "봐잌"},
    "Future": {"full": "미래형", "abbr": "미"},
    "Pluperfect": {"full": "대과거형", "abbr": "대과"},
    "impv": {"full": "명령형", "abbr": "명령"},
    "infa": {"full": "부정사 절대형", "abbr": "부절"},
    "infc": {"full": "부정사 연계형", "abbr": "부연"},
    "ptca": {"full": "능동분사", "abbr": "능분"},
    "ptcp": {"full": "수동분사", "abbr": "수분"},
    "Aorist": {"full": "아오리스트", "abbr": "아오"},
    "Present": {"full": "현재", "abbr": "현"},
    "Past": {"full": "과거", "abbr": "과"},
    ...
    "Active": {"full": "능동태", "abbr": "능동"},
    "Passive": {"full": "수동태", "abbr": "수동"},
    "Middle": {"full": "중간태", "abbr": "중간"},
    "Middlepassive": {"full": "중간수동태", "abbr": "중수"},
    "Indicative": {"full": "직설법", "abbr": "직설"},
    "Imperative": {"full": "명령법", "abbr": "명령"},
    "Subjunctive": {"full": "가정법", "abbr": "가정"},
    "Optative": {"full": "기원법", "abbr": "기원"},
    "Participle": {"full": "분사", "abbr": "분사"},
    "Infinitive": {"full": "부정사", "abbr": "부"},
    "Nominative": {"full": "주격", "abbr": "주격"},
    "Accusative": {"full": "목적격", "abbr": "목적"},
